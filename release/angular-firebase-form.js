...
.controller('FormController', ['$scope', '$mdToast', '$location', 'MessageFactory', function($scope, $mdToast, $location, MessageFactory) {
  'use strict';
...
.factory('MessageFactory', ['$q', '$http', 'firebaseForm', function($q, $http, firebaseForm) {
  'use strict';
